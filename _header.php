...
<body>
    ...
    <div class="wrap">
        ...
        <nav>
            ...
            <a href="/noticias.php"><i class="fas fa-fw fa-newspaper"></i> <span>Notícias</span></a>
            <a href="/contacts.php"><i class="fas fa-fw fa-comments"></i> <span>Contatos</span></a>
            <a href="/sobre.php"><i class="fas fa-fw fa-info-circle"></i> <span>Sobre</span></a>
        </nav>
